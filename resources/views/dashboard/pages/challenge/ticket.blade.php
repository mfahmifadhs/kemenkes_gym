                ...
                <div class="section-body mb-5">
                    <div class="schedule p-3 border-main">
                        <div class="text-center">
                            ...
                            <a href="{{ route('challenge.download', ['id' => $data->id_detail, 'form' => 'penyataan']) }}" class="btn btn-default btn-md text-white text-uppercase bg-main mt-3" onabort="confirmDownload(event)">
