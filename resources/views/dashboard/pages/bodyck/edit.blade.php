        ...
        <div class="row identity">
            <div class="col-md-9 mx-auto">
                ...
                <div class="section-body">
                    <div class="section-title mb-2"><span>Edit Body Check</span></div>
                    <div class="schedule">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-12 col-12 mb-0">
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 mb-2 col-form-label text-white">{{ $loop->iteration.'. '.$row->param->nama_param .' '. $row->param->satuan }}*</div>
